...
//main app bundle id
#define MAIN_APP_ID @"com.nextlinux.macsf.app"

//helper (login item) ID
#define HELPER_ID @"com.nextlinux.macsf.helper"

//installer (app) ID
#define CONFIG_ID @"com.nextlinux.macsf.config"

//installer (helper) ID
#define CONFIG_HELPER_ID @"com.nextlinux.macsf.configHelper"
...
//daemon mach name
#define DAEMON_MACH_SERVICE @"com.nextlinux.macsf"
