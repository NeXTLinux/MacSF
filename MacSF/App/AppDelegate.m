...
-(BOOL)shouldLaunchUninstaller
{
    ...
    return [NSFileManager.defaultManager fileExistsAtPath:[INSTALL_DIRECTORY stringByAppendingPathComponent:@"MacSF.bundle"]];
}
...
-(BOOL)applicationShouldHandleReopen:(NSApplication *)sender hasVisibleWindows:(BOOL)hasVisibleWindows
{
    ...
    {
        //show alert
        showAlert(@"MacSF's Network Extension Is Not Running", @"Extensions must be manually approved via Security & Privacy System Preferences.");
...
-(IBAction)quit:(id)sender
{
    ...
    //main text
    alert.messageText = @"Quit MacSF?";

    //details
    alert.informativeText = @"...this will exit MacSF (until restart/(re)login).";
...
{
    //find match
    // will check if MacSF's, then will terminate
    for(NSRunningApplication* networkMonitor in [NSRunningApplication runningApplicationsWithBundleIdentifier:@"com.nextlinux.Netiquette"])
    {
        //non MacSF instance?
...
-(IBAction)uninstall:(id)sender
{
    ...
    //main text
    alert.messageText = @"Uninstall MacSF?";
    
    //details
    alert.informativeText = @"...this will fully remove MacSF from your Mac!";
