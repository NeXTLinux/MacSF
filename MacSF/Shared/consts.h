...
//bundle ID
#define BUNDLE_ID "com.nextlinux.macsf"

//extension bundle ID
#define EXT_BUNDLE_ID @"com.nextlinux.macsf.extension"

//main app bundle id
#define APP_ID @"com.nextlinux.macsf.app"

//signing auth
#define SIGNING_AUTH @"Developer ID Application: NeXTLinux, LLC (VBG97UB4TA)"

//firewall event: new flow
#define LULU_EVENT @"com.nextlinux.macsf.event"

//macsf service
#define LULU_SERVICE_NAME "com_objective_see_firewall"

//install directory
#define INSTALL_DIRECTORY @"/Library/NeXTLinux/MacSF"
...
//daemon mach name
#define DAEMON_MACH_SERVICE @"VBG97UB4TA.com.nextlinux.macsf"
...
//product version url
#define PRODUCT_VERSIONS_URL @"https://nextlinux.com/products.json"

//product key
#define PRODUCT_KEY @"MacSF"

//product url
#define PRODUCT_URL @"https://nextlinux.com/products/macsf.html"

//error(s) url
#define ERRORS_URL @"https://nextlinux.com/errors.html"
...
//login item name
#define LOGIN_ITEM_NAME @"MacSF Helper"
...
//log file
#define LOG_FILE_NAME @"MacSF.log"
...
//general error URL
#define FATAL_ERROR_URL @"https://nextlinux.com/errors.html"
...
//rules changed
#define RULES_CHANGED @"com.nextlinux.macsf.rulesChanged"

//extension event
#define EXTENSION_EVENT @"com.nextlinux.macsf.extensionEvent"
...
//launch daemon name
#define LAUNCH_DAEMON_BINARY @"MacSF"

//launch daemon plist
#define LAUNCH_DAEMON_PLIST @"com.nextlinux.macsf.plist"
...
//uninstaller
#define UNINSTALLER_V1 @"MacSF Uninstaller.app"
